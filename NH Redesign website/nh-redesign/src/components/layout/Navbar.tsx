    ...
    >
      <div style={{ maxWidth: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", height: "68px", margin: "0 auto", padding: "0 80px" }} className="container">
        <div style={{ display: "flex", alignItems: "center", gap: "40px" }}>
          <Link aria-label="Narayana Health Home" style={{ flexShrink: 0 }} href="/">
            <div style={{ width: "135px", height: "auto", display: "flex", alignItems: "center" }}>
              <Image alt="Narayana Health" width={135} height={42} style={{ color: "transparent", width: "100%", height: "auto", filter: isNavbarActive ? "none" : "brightness(0) invert(1)" }} src="/NH-logo.svg" priority />
            </div>
          </Link>
          ...
          <li style={{ position: "relative" }}>
            <Link style={{ color: isNavbarActive ? "var(--text-primary, #333)" : "#FFFFFF", fontSize: "14px", fontWeight: 500, padding: "8px 12px", borderRadius: "var(--radius-sm, 4px)", display: "flex", alignItems: "center", gap: "4px", transition: "all 0.15s", whiteSpace: "nowrap", position: "relative" }} href="/health-insurance">
              Health Insurance
            </Link>
          </li>
          <li style={{ position: "relative" }}>
            <Link 
              className={isNavbarActive ? "" : styles.gradientPulseText} 
              style={{ 
                color: isNavbarActive ? "#333333" : undefined, 
                fontSize: "14px", 
                fontWeight: 500, 
                padding: "8px 12px", 
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "var(--space-3, 12px)" }}>
          ...
          <button aria-label="Search" onClick={() => setIsSearchOpen(true)} style={{ padding: "8px", cursor: "pointer", background: "transparent", border: "none", color: isNavbarActive ? "var(--text-primary, #333)" : "#FFFFFF", display: "flex", alignItems: "center", transition: "color 0.2s" }}>
            <Search size={18} strokeWidth={2.5} />
          </button>
          <Link style={{ border: isNavbarActive ? "1px solid var(--nh-red, #d93832)" : "1px solid rgba(255, 255, 255, 0.4)", color: isNavbarActive ? "var(--nh-red, #d93832)" : "#FFFFFF", padding: "8px 20px", borderRadius: "9999px", fontSize: "13px", fontWeight: 600, textDecoration: "none", transition: "all 0.2s ease" }} href="/login">
            Login
          </Link>
          <button aria-label="Open navigation menu" style={{ color: isNavbarActive ? "var(--text-primary, #333)" : "#FFFFFF", padding: "8px", display: "none" }} className="mobile-menu-btn">
            <Menu size={24} />
          </button>
        </div>
      </div>
